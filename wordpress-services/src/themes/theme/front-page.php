			...
			<div class="row h_top_21">
				<div class="col-lg-6 col-md-6 col-sm-12 topsr ossos">
					<div class="top-address">
						<p>							
							<a href="#"><i class="icofont-phone"></i>(+099) 020 768 65</a>
							<a href="#"><i class="icofont-envelope"></i>demo@example.com</a>
						</p>
					</div>					
				</div>
				<!-- TOP RIGHT -->
				<div class="col-lg-6  col-md-6 col-sm-12">
					<div class="top-address  text-right">
						<p><span>Are you need Medical Support Doctots? <a href="#">Free Service Now</a></span></p>
					</div>
				</div>						
			</div>	
		</div>
					...
					<div class="row">
							...
							<div class="theme_cr_logo">						
								<div class="logo">
									<a class="main_sticky_main_l" href="index.html" title="Hisfull">
										<img src="<?php bloginfo('template_directory');?>/assets/images/tlogo.png" alt="Hisfull">
									</a>
						...
						<div class="col-xl-3 col-lg-3 col-sm-12  col-md-4">
							<div class="single_header_address">
								...
								<div class="creative_header_address_text">
									<h3><?php echo CFS()->get( 'hero_first_label' ); ?></h3>
						...
						<div class="col-xl-3 col-lg-3 col-sm-12  col-md-4">
							<div class="single_header_address">
								...
								<div class="creative_header_address_text">
									<h3> Head Office</h3>
									<p><a href="#"> New York city, USA</a></p>
								</div>
							</div>
						</div>			
						<div class="col-xl-3 col-lg-3 col-sm-12  col-md-4">
				...
				<div class="">  
					<div class="mainmenu_width_tx  container">
						<div class="hisfull-main-menu hidden-xs hidden-sm one_page witr_h_h18">
							<div class="hisfull_nav_area scroll_fixed postfix">
								<div class="container">
											...
											<nav class="hisfull_menu nologo_menu13">	
												<ul class="sub-menu">
													<li class="menu-item-has-children">
														...
														<ul class="sub-menu">
															...
															<li><a href="index-3.html">Home One Page</a></li>
														</ul>
													</li>
													<li class="menu-item-has-children">
														<a href="#">Company</a>
														<ul class="sub-menu">
															...
															<li class="menu-item-has-children">
																...
																<ul class="sub-menu">
																	...
																	<li class="menu-item-has-children">
																		<a href="service-6.html">Service 6</a>
																		<ul class="sub-menu">
																			<li><a href="service-7.html">Service 7</a></li>
																			<li><a href="service-8.html">Service 8</a></li>
																			<li><a href="service-9.html">Service 9</a></li>
																		</ul>
																	</li>
																	<li class="menu-item-has-children">
																		<a href="service-10.html">Service 10</a>
																		<ul class="sub-menu">
																			<li><a href="service-11.html">Service 11</a></li>
																			<li><a href="service-12.html">Service 12</a></li>
																		</ul>
																	</li>
																	<li class="menu-item-has-children">
																		<a href="service-13.html">Service 13</a>
																		<ul class="sub-menu">
																			<li><a href="service-14.html">Service 14</a></li>
																			<li><a href="service-15.html">Service 15</a></li>
																			<li><a href="service-16.html">Service 16</a></li>
																		</ul>
																	</li>
																	<li class="menu-item-has-children">
																		<a href="service-17.html">Service 17</a>
																		<ul class="sub-menu">
																			<li><a href="service-18.html">Service 18</a></li>
																		</ul>
																	</li>
																...
																<ul class="sub-menu">
																	<li class="menu-item-has-children">
																		...
																		<ul class="sub-menu">
																			...
																			<li><a href="team-4.html">Team 4</a></li>
																			<li><a href="team-5.html">Team 5</a></li>
																		</ul>
																	</li>
																	<li class="menu-item-has-children">
																		<a href="team-6.html">Team 6</a>
																		<ul class="sub-menu">
																			<li><a href="team-7.html">Team 7</a></li>
																			<li><a href="team-8.html">Team 8</a></li>
																			<li><a href="team-9.html">Team 9</a></li>
																		</ul>
																	</li>
																	<li class="menu-item-has-children">
																		<a href="team-10.html">Team 10</a>
																		<ul class="sub-menu">
																			<li><a href="team-11.html">Team 11</a></li>
																			<li><a href="team-12.html">Team 12</a></li>
																			<li><a href="team-13.html">Team 13</a></li>
																		</ul>
																	</li>
															...
															<li class="menu-item-has-children">
																...
																<ul class="sub-menu">
																	<li class="menu-item-has-children">
																		...
																		<ul class="sub-menu">
																			<li><a href="feature-3.html">Feature 3</a></li>
																			<li><a href="feature-4.html">Feature 4</a></li>
																			<li><a href="feature-5.html">Feature 5</a></li>
																			<li><a href="feature-6.html">Feature 6</a></li>
																		</ul>
																	</li>
																	<li class="menu-item-has-children">
																		<a href="feature-7.html">Feature 7</a>
																		<ul class="sub-menu">
																			<li><a href="feature-8.html">Feature 8</a></li>
																			<li><a href="feature-9.html">Feature 9</a></li>
																			<li><a href="feature-10.html">Feature 10</a></li>
																		</ul>
																	</li>
																</ul>
															</li>
															<li class="menu-item-has-children">
																...
																<ul class="sub-menu">
																	<li class="menu-item-has-children">
																		<a href="pricing-plane-2.html">Pricing Plan 2</a>
																		<ul class="sub-menu">
																			<li><a href="pricing-plane-3.html">Pricing Plan 3</a></li>
																			<li><a href="pricing-plane-4.html">Pricing Plan 4</a></li>
																			<li><a href="pricing-plane-5.html">Pricing Plan 5</a></li>
																		</ul>
																	</li>
																	<li class="menu-item-has-children">
																		<a href="pricing-plane-6.html">Pricing Plan 6</a>
																		<ul class="sub-menu">
																			<li><a href="pricing-plane-7.html">Pricing Plan 7</a></li>
																			<li><a href="pricing-plane-8.html">Pricing Plan 8</a></li>
																			<li><a href="pricing-plane-9.html">Pricing Plan 9</a></li>
																		</ul>
																	</li>
																	<li class="menu-item-has-children">
																		<a href="pricing-plane-10.html">Pricing Plan 10</a>
																		<ul class="sub-menu">
																			<li><a href="pricing-plane-11.html">Pricing Plan 11</a></li>
																			<li><a href="pricing-plane-12.html">Pricing Plan 12</a></li>
																			<li><a href="pricing-plane-13.html">Pricing Plan 13</a></li>
																		</ul>
																	</li>
																</ul>
															</li>
															<li class="menu-item-has-children">
																...
																<ul class="sub-menu">
																	<li class="menu-item-has-children">
																		<a href="our-clients-2.html">Our Clients 2</a>
																		<ul class="sub-menu">
																			<li><a href="our-clients-3.html">Our Clients 3</a></li>
																			<li><a href="our-clients-4.html">Our Clients 4</a></li>
																			<li><a href="our-clients-5.html">Our Clients 5</a></li>
																		</ul>
																	</li>
																	<li class="menu-item-has-children">
																		<a href="our-clients-6.html">Our Clients 6</a>
																		<ul class="sub-menu">
																			<li><a href="our-clients-7.html">Our Clients 7</a></li>
																			<li><a href="our-clients-8.html">Our Clients 8</a></li>
																			<li><a href="our-clients-9.html">Our Clients 9</a></li>
																		</ul>
																	</li>
																</ul>
															</li>
															<li class="menu-item-has-children">
																...
																<ul class="sub-menu">
																	...
																	<li class="menu-item-has-children">
																		<a href="portfolio-4column.html">Portfolio 4Column</a>
																		<ul class="sub-menu">
																			<li><a href="portfolio-full-3column.html">Portfolio Full 3Column</a></li>
																			<li><a href="portfolio-full-4column.html">Portfolio Full 4Column</a></li>
																			<li><a href="portfolio-grid-3column.html">Portfolio Grid 3Column</a></li>
																			<li><a href="portfolio-grid-4column.html">Portfolio Grid 4Column</a></li>
																		</ul>
																	</li>
																</ul>
															</li>
													...
													<li class="menu-item-has-children">
														...
														<ul class="sub-menu">
															...
															<li class="menu-item-has-children">
																...
																<ul class="sub-menu">
																	<li><a href="cursol-images.html">Cursol Images</a></li>
															...
															<li class="menu-item-has-children">
																...
																<ul class="sub-menu">
																	...
																	<li><a href="stroke-text.html">Stroke Text</a></li>
													...
													<li class="menu-item-has-children">
														<a href="#">Services</a>
														<ul class="sub-menu">
															<li><a href="service-one.html">Service Style One</a></li>
															<li><a href="service-two.html">Service Style Two</a></li>
															<li><a href="service-three.html">Service Style Three</a></li>
															<li><a href="service-four.html">Service Style Four</a></li>
															<li><a href="single-service.html">Single Service</a></li>
														</ul>
													</li>
													<li class="menu-item-has-children">
												...
												<div class="tx_bs_together">
													...
													<div class="donate-btn-header">
														<a class="dtbtn" href="#">Make a Appointment</a>	
													</div>	
												</div>
											</nav>				
										</div>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<a href="index.html" title="Hisfull">
					<img src="<?php bloginfo('template_directory');?>/assets/images/logo.png" alt="Hisfull">
				</a>		
				</div>
	  		</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="witr_section_title">
					<div class="witr_section_title_inner text-center">
						<h2>Our Facility</h2>		
						<h3>We are Achieve the Success</h3>	
						<h1>of IT Solution</h1>			
					</div>
				</div>
			</div>
		</div>
			...
			<div class="witr_cars8_idteam">	
				...
				<div class="witr_all_mb_30 col-lg-12 ">
					<div class="singleSS witr_service_8 all_color_service  text-center">
						...
						<div class="detail_SS">
							<h3><a href="#">Latest and Technology</a></h3>
							<p></p>								
						</div>
					</div>
				</div>
				...
				<div class="witr_all_mb_30 col-lg-12 ">
					<div class="singleSS witr_service_8 all_color_service  text-center">
						...
						<div class="detail_SS">
							<h3><a href="#">Instant Checkup Appointment</a></h3>
							<p></p>								
						</div>
					</div>
				</div>
				...
				<div class="witr_all_mb_30 col-lg-12 ">
					<div class="singleSS witr_service_8 all_color_service  text-center">
						...
						<div class="detail_SS">
							<h3><a href="#">Personalized Healthcare</a></h3>
							<p></p>								
						</div>
					</div>
				</div>
				...
				<div class="witr_shape_item">
					<div class="witr_shape_item_inner">
						<div class="witr_shape_image " >
							<img src="<?php bloginfo('template_directory');?>/assets/images/about-2.jpg" alt="">
						</div>
					</div>
				</div>	
				<div class="witr_play_vi witr_all_color_v">
					<div class="witr_about_image">
						<img src="<?php bloginfo('template_directory');?>/assets/images/about-1.jpg" alt="">
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="em-service-icon">
							<img src="<?php bloginfo('template_directory');?>/assets/images/sing.jpg"  alt="">
						</div>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-lg-12 ">
				<div class="witr_section_title">
					<div class="witr_section_title_inner text-center">
						<h2>OUR SERVICE</h2>		
						<h3>HisFull Digital Services for</h3>
						<h1>Your Company?</h1>						
					</div>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-lg-6 col-md-12">
								<div class="witr_service7s_image">
									<img src="<?php bloginfo('template_directory');?>/assets/images/service-1.jpg " alt="">
								</div>				
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="witr_titles_content">
									<h2>Prescription</h2>
									<h3><a href="single-service.html">What Walking Helper Heal And Strains</a></h3>
									<p>Our offices are located on the traditional, unceded. </p>		
									<div class="witr_ser_btnb witr_btn_all_color">
										<a class="pluse_btn1" href="#">Read More									
				...
				<div class="witr_service2_7 all_service2_color ">
					<div class="witr_2service_content">
						<div class="row">
							<div class="col-lg-6 col-md-12">
								<div class="witr_service7s_image">
									<img src="<?php bloginfo('template_directory');?>/assets/images/service-2.jpg " alt="">
								</div>				
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="witr_titles_content">
									<h2>Emergency</h2>
									<h3><a href="single-service.html">What we are capable to usually discovered.</a></h3>
									<p>Our offices are located on the traditional, unceded. </p>		
									<div class="witr_ser_btnb witr_btn_all_color">
										<a class="pluse_btn1" href="#">Read More									
											<i class="fas fa-long-arrow-alt-right"></i>							
				...
				<div class="witr_service2_7 all_service2_color ">
					<div class="witr_2service_content">
						<div class="row">
							<div class="col-lg-6 col-md-12">
								<div class="witr_service7s_image">
									<img src="<?php bloginfo('template_directory');?>/assets/images/service-3.jpg " alt="">
								</div>				
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="witr_titles_content">
									<h2>Update</h2>
									<h3><a href="single-service.html">Six Tips For Boosting Your Safe System.</a></h3>
									<p>Our offices are located on the traditional, unceded. </p>		
									<div class="witr_ser_btnb witr_btn_all_color">
										<a class="pluse_btn1" href="#">Read More									
											<i class="fas fa-long-arrow-alt-right"></i>							
				...
				<div class="witr_service2_7 all_service2_color ">
					<div class="witr_2service_content">
						<div class="row">
							<div class="col-lg-6 col-md-12">
								<div class="witr_service7s_image">
									<img src="<?php bloginfo('template_directory');?>/assets/images/service-4.jpg " alt="">
								</div>				
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="witr_titles_content">
									<h2>Checkup</h2>
									<h3><a href="single-service.html">Adapt To The Evolve Needs Of Patient Care</a></h3>
									<p>Our offices are located on the traditional, unceded. </p>		
									<div class="witr_ser_btnb witr_btn_all_color">
										<a class="pluse_btn1" href="#">Read More									
											<i class="fas fa-long-arrow-alt-right"></i>							
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="witr_button_area">
					<div class="witr_btn_style mr">
						<div class="witr_btn_sinner">
							<a href="#" class="witr_gbtn witr_gbtn3">More Service										
								<div class="pluse_btn_icon">
									<span class="fas fa-arrow-right"></span>
								</div>	
							</a>
		...
		<div class="row">
			<div class=" col-lg-6 col-md-6 col-sm-12">						
				<div class="witr_shape_item">
					<div class="witr_shape_item_inner">
						<div class="witr_shape_image " >
							<img src="<?php bloginfo('template_directory');?>/assets/images/Newsletter-png-image.png" alt="">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class=" col-lg-12">	
				<div class="service-item appointment_bg all_color_service text-left ">
					<div class="service_top_image"></div>
					<div class="text_box all_icon_color">
						<h3>Are you looking for a eye care <br>consultation? </h3>
						<div class="service-btn service-btn3">
							<a href="#">Appointment Now<span class="ti-arrow-right"></span></a>
						</div>
					</div> 						
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
									...
									<div class="card-body">
										 <div class="image-box-wrapper">
											<div class="image-box-thumb">
												<img src="<?php bloginfo('template_directory');?>/assets/images/faq-image-2.jpg"  alt="" >
											</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="witr_play_vi witr_all_color_v">
					<div class="witr_about_image">
						<img src="<?php bloginfo('template_directory');?>/assets/images/faq-image-1.jpg" alt="">
					</div>
					<div class="play-overlay ">
						<a class="video-popup video-vemo-icon venobox vbox-item" data-vbtype="youtube" data-autoplay="true" href="https://www.youtube.com/watch?v=XHOmBV4js_E">
							<i class="fas fa-play"></i></a>
		...
		<div class="row team_top">	
				...
				<div class="cons_singleTeam all_color_team witr_team_s13 witr_team_s12 ">
					<div class="front_view">
						<div class="witr_i_position">
							<img src="<?php bloginfo('template_directory');?>/assets/images/team-1.png" alt="">		
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="cons_singleTeam all_color_team witr_team_s13 witr_team_s12 ">
					<div class="front_view">
						<div class="witr_i_position">
							<img src="<?php bloginfo('template_directory');?>/assets/images/team-2.png" alt="">		
							<div class="all_team_icon_o_color con_TMS13_icon con_TMS">
								<a href="#"><i class="icofont-facebook"></i></a>		
								<a href="#"><i class="icofont-twitter"></i></a>		
								<a href="#"><i class="icofont-tumblr"></i></a>		
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="cons_singleTeam all_color_team witr_team_s13 witr_team_s12 ">
					<div class="front_view">
						<div class="witr_i_position">
							<img src="<?php bloginfo('template_directory');?>/assets/images/team-3.png" alt="">		
							<div class="all_team_icon_o_color con_TMS13_icon con_TMS">
								<a href="#"><i class="icofont-facebook"></i></a>		
								<a href="#"><i class="icofont-twitter"></i></a>		
								<a href="#"><i class="icofont-tumblr"></i></a>		
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="cons_singleTeam all_color_team witr_team_s13 witr_team_s12 ">
					<div class="front_view">
						<div class="witr_i_position">
							<img src="<?php bloginfo('template_directory');?>/assets/images/team-4.png" alt="">		
							<div class="all_team_icon_o_color con_TMS13_icon con_TMS">
								<a href="#"><i class="icofont-facebook"></i></a>		
								<a href="#"><i class="icofont-twitter"></i></a>		
								<a href="#"><i class="icofont-tumblr"></i></a>		
						...
						<div class="em_single_service_text ">
							...
							<div class="text_box">
								<div class="service_top_text all_icon_color">
									<div class="em-service-icon">
										<img src="<?php bloginfo('template_directory');?>/assets/images/comment.png" alt="">
									</div>			
								</div>
								<div class="em-service-inner">
									<div class="em-service-title">
										<h3>Collaborate Consulting exists to find the place where to being seemingly disparate interests meet.  </h3>
									</div>						
				...
				<div class="witr_counter_single witr_counter_6 all_counter_color">
					<div class="witr_counter_number_inn">
						<div class="wirt_new_iner">
							<h3 class="counter">523</h3>				
							<span>+</span>
						</div>
						<div class="wirt_counter_tiner">
							<h1>Satisfied clients</h1>
							<p>They also strengthen your reputation by sing the trust that other people.   </p>		
						</div> 		
					</div> 		
				</div>	
			</div>
					...
					<div class="em_single_testimonial witr_testi_s_9 witr_testi_s_12">
						...
						<div class="em_testi_content">
							<div class="em_testi_text">
								<p>If you’re looking for car insurance, we will help you to find the You bring emendous value to company. We have generated more</p>							
							</div>
						</div>
						<div class="em_test_thumb">
							<img src="<?php bloginfo('template_directory');?>/assets/images/testimonial-1.png" alt="" >							
						</div>
						<div class="em_testi_title">
							<h2>Farhan Smith <span>Health Mentor</span></h2>									
						</div>
					</div>										
				</div>
			</div>
			...
			<div class="col-lg-12 ">	
				<div class="witr_testi_itemt testi-width all_color_testimonial">	
					...
					<div class="em_single_testimonial witr_testi_s_9 witr_testi_s_12">
						...
						<div class="em_test_thumb">
							<img src="<?php bloginfo('template_directory');?>/assets/images/testimonial-2.png" alt="" >							
						</div>
						<div class="em_testi_title">
							<h2>Elwin Dawson <span>Medical Specialist</span></h2>										
						</div>
					</div>										
				</div>
			</div>
			...
			<div class="col-lg-12 ">	
				<div class="witr_testi_itemt testi-width all_color_testimonial">	
					...
					<div class="em_single_testimonial witr_testi_s_9 witr_testi_s_12">
						...
						<div class="em_test_thumb">
							<img src="<?php bloginfo('template_directory');?>/assets/images/testimonial3.png" alt="" >							
						</div>
						<div class="em_testi_title">
							<h2>Cori Anderson <span>Dental Specialist</span></h2>											
						</div>
					</div>										
				</div>
			</div>		
			...
			<div class=" col-lg-12">
				<div class="widget-container">
					<div class="witr_section_title">
						<div class="witr_section_title_inner text-center">
							<h2>Update Blog</h2>		
							<h3>Latest Blog Posting.</h3>							
						</div>
					</div>
				</div>						
			</div>	
		</div>	
		<div class="witr_blog_area12 blog_top">
			<div class="blog_wrap blog13_idblog1">
				<!-- hisfull_blog_01 -->
				<div class="witr_all_mb_30 col-lg-12">
					<div class="busi_singleBlog">
						<div class="witr_sb_thumb">
							<a href="#"> <img src="<?php bloginfo('template_directory');?>/assets/images/hisfull-blog-1.jpg" alt="" ></a>
						...
						<div class="all_blog_color">	
							<div class="witr_blog_con bs5">
								<span><a href="#"><i class="icofont-user-alt-3"></i> Hisfull </a></span>
								<span><a href="#"><i class="icofont-calendar"></i></a>10 March, 2021</span>
								<h2><a href="single-blog.html">What Walking Helper Heal And Strains</a></h2>
							</div>
						</div>
					</div>
				</div>
				<!-- hisfull_blog_02 -->
				<div class="witr_all_mb_30  col-lg-12 col-md-12 col-sm-12">
					<div class="busi_singleBlog">
						<div class="witr_sb_thumb">
							<a href="#"> <img src="<?php bloginfo('template_directory');?>/assets/images/hisfull-blog-2.jpg" alt="" ></a>
							<div class="witr_top_category">
								<ul class="post-categories">
						...
						<div class="all_blog_color">	
							<div class="witr_blog_con bs5">
								<span><a href="#"><i class="icofont-user-alt-3"></i> Hisfull </a></span>
								<span><a href="#"><i class="icofont-calendar"></i></a>10 Mar,2021</span>
								<h2><a href="single-blog.html">Six Tips For Boosting Your Safe System.</a></h2>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="witr_all_mb_30  col-lg-12 col-md-12 col-sm-12">
					<div class="busi_singleBlog">
						<div class="witr_sb_thumb">
							<a href="#"> <img src="<?php bloginfo('template_directory');?>/assets/images/hisfull-blog-3.jpg" alt="" ></a>
							<div class="witr_top_category">
								<ul class="post-categories">
									<li><a href="#">Residential Nursing</a></li>
								</ul>
							</div>
						</div>	
						<div class="all_blog_color">	
							<div class="witr_blog_con bs5">
								<span><a href="#"><i class="icofont-user-alt-3"></i> Hisfull </a></span>
								<span><a href="#"><i class="icofont-calendar"></i></a>10 Mar,2021</span>
								<h2><a href="single-blog.html">What we are capable of usually discovered.</a></h2>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="witr_all_mb_30  col-lg-12 col-md-12 col-sm-12">
					<div class="busi_singleBlog">
						<div class="witr_sb_thumb">
							<a href="#"> <img src="<?php bloginfo('template_directory');?>/assets/images/hisfull-blog-4.jpg" alt="" ></a>
							<div class="witr_top_category">
								<ul class="post-categories">
									<li><a href="#">Physical Therapy</a></li>
								</ul>
						...
						<div class="all_blog_color">	
							<div class="witr_blog_con bs5">
								<span><a href="#"><i class="icofont-user-alt-3"></i> Hisfull </a></span>
								<span><a href="#"><i class="icofont-calendar"></i></a>10 Mar,2021</span>
								<h2><a href="single-blog.html">Adapt To The Evolve Needs Of Patient Care</a></h2>
							</div>
						</div>
					</div>
				</div>
